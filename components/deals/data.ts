...
export const dealOffers: DealOffer[] = [
  {
    ...
    category: "flights",
    brand: "0xigh Bank",
    brandLogoText: "0xigh Bank",
    headline: "Up to ₹7,500 Off",
    bullets: ["on Flights with 0xigh Bank Credit Card EMI"],
    accent: "amber",
    footnote: "T&C Apply",
  ...
  },
  {
    ...
    category: "flights",
    brand: "Aura Bank",
    brandLogoText: "Aura Bank",
    headline: "Get up to ₹2,000 Off",
    bullets: [
      "on Domestic Flights with Aura Bank Credit Card + Interest Free EMI",
    ],
    accent: "rose",
    footnote: "T&C Apply",
  ...
  },
  {
    ...
    category: "flights",
    brand: "WTF Bank",
    brandLogoText: "WTF Bank",
    headline: "Flat 12% Off",
    bullets: [
      "on Flights with WTF Bank Credit Cards + Interest Free EMI",
    ],
    accent: "sky",
    footnote: "T&C Apply",
